...
curve(df(x, df1 = fit_null$df.residual-fit1$df.residual,
   df2 = fit1$df.residual), from = 0, to = 10, ylab = "density")
# the rejection region at alpha = 1%
abline(v = qf(0.99,  df1 = fit_null$df.residual-fit1$df.residual,
   df2 = fit1$df.residual), col = "darkred", lty = 2)
```
